"""
Django settings for Krisha project.
...
SECRET_KEY = 'm4(vzg&l_tioy=n+zkrixt+8%6nu@mtfly3rl#=-%59_pe@8(j'
...
WSGI_APPLICATION = 'Krisha.wsgi.application'
